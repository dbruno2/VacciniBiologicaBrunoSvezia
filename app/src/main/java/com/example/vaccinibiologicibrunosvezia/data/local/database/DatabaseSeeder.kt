...
/**
 * DatabaseSeeder: Gestisce il popolamento iniziale del database con dati predefiniti.
 * Separato dalla definizione del database per favorire la testabilità e il disaccoppiamento.
 */
object DatabaseSeeder {

    /**
     * seed: Inserisce vaccini e regole cliniche se il database è vuoto.
     */
    suspend fun seed(db: AppDatabase) {
        val vDao = db.vaccineDao()
        val rDao = db.ruleDao()

        // Verifichiamo se il database è già popolato controllando l'esistenza di un vaccino chiave.
        ...
        // 2. Inserimento delle Regole Cliniche
